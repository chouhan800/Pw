...
OWNER_ID = 8050673236 # Replace with the actual owner's user ID
...
image_urls = [
    "https://radare.arzfun.com/api/tg/photo?id=BQACAgUAAxkBAAEF6MFosqTecs0J47INRs_S5IO0DcwgQwACjRcAAr06kVV8wtzxMFLQ2jYE",
...
async def upload(bot: Client, m: Message):
    ...
    await editable.edit("𝗡𝗼𝘄 
    𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://graph.org/file/13a89d77002442255efad-989ac290c1b3f13b44.jpg\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
